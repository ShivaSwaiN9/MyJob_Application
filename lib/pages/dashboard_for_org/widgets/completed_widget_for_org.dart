...
class CompletedWidgetForOrg extends StatefulWidget {
  const CompletedWidgetForOrg({Key? key}) : super(key: key);

  @override
  State<CompletedWidgetForOrg> createState() => _CompletedWidgetForOrgState();
}

class _CompletedWidgetForOrgState extends State<CompletedWidgetForOrg> {
  late CompletedWidgetForOrgController controller;

  @override
  void initState() {
    super.initState();
    controller = Get.find<CompletedWidgetForOrgController>();
  }
