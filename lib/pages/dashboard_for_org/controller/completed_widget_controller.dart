...
class CompletedWidgetController extends GetxController
  ...
  void onInit() {
    ...
    scrollController.addListener(() {
      ...
      if (maxGeneralScroll <= currentGeneralScroll) {
        getMoreEmployeeRequestCompleted();
      }
    });
  }
  ...
  void getEmployeeRequestCompleted() async {
    skip = 0;
    shouldLoadMore = true;
    try {
  ...
  void getMoreEmployeeRequestCompleted() async {
  ...
  removeCompletedRequest(EmployeeRequestDatum? datum) {
