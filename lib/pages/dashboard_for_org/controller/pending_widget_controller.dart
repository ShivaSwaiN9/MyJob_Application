...
class PendingWidgetController extends GetxController
  ...
  void getEmployeeRequestPending() async {
    skip = 0;
    shouldLoadMore = true;
    try {
  ...
  void getMoreEmployeeRequestPending() async {
  ...
  removePendingRequest(EmployeeRequestDatum? datum) {
