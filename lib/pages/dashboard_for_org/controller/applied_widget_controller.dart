...
class AppliedWidgetController extends GetxController
  ...
  void getEmployeeRequestApplied() async {
    skip = 0;
    shouldLoadMore = true;
    try {
  ...
  void getMoreEmployeeRequestApplied() async {
  ...
  removeAppliedRequest(EmployeeRequestDatum? datum) {
