...
/// On 15/07/22 11:26 AM
///
class SubscriptionCouponWidget extends StatelessWidget {
  final VoidCallback? onTap, onDelete;
  const SubscriptionCouponWidget({Key? key, this.onTap, this.onDelete})
      : super(key: key);
                                ...
                                text: TextSpan(
                                  ...
                                  TextSpan(
                                    text: controller.selectedCoupon!.type == 1
                                        ? "\n${formatPercentage(controller.selectedCoupon!.discount!)}% Off (You save ₹${controller.getDiscountPrice(controller.selectedCoupon!, controller.planDatum)})"
                                        : "\n${formatPrice(controller.selectedCoupon!.discount!)} Off (You save ₹${controller.getDiscountPrice(controller.selectedCoupon!, controller.planDatum)})",
                                    style: TextStyle(
                                        fontWeight: FontWeight.w400,
                                        fontSize: 14),
                                  )
