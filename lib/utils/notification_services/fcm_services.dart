...
Future<dynamic> backgroundMessageHandler(RemoteMessage message) async {
  try {
    ...
    NotificationDatum notificationData =
        NotificationDatum.fromJson(message.data);
    //
    return InAppNotification.showNotification(
      ...
      data: jsonEncode(notificationData.toJson()),
    );
  } catch (e, s) {
...
void onNotificationTapped(NotificationDatum notificationDatum) {
  Get.toNamed(RequestDetailPage.routeName,
      preventDuplicates: false,
      arguments: {"requestDatum": notificationDatum.entityId});
