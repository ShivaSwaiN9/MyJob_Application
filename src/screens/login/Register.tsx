...
const Register = ({navigation}:any) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <ImageBackground
                source={require('../../assets/PNG/AFLBG.png')} // Replace with your background image file
            ...
            <View style={styles.buttonsContainer}>
                ...
                >
                    <Image source={require('../../assets/PNG/case.png')} style={{height:20,width:20}} />
                ...
                >
                    <Image source={require('../../assets/PNG/team.png')} style={{height:20,width:20}} />
