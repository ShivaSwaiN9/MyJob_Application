...
const specializations = [
  { id: '1', title: 'Design', jobs: 140, icon: require('../../assets/PNG/Group1.png') },
  { id: '2', title: 'Finance', jobs: 250, icon: require('../../assets/PNG/Group2.png') },
  { id: '3', title: 'Education', jobs: 120, icon: require('../../assets/PNG/Group3.png') },
  { id: '4', title: 'Restaurant', jobs: 85, icon: require('../../assets/PNG/Group4.png') },
  { id: '5', title: 'Health', jobs: 235, icon: require('../../assets/PNG/Group5.png') },
  { id: '6', title: 'Programmer', jobs: 412, icon: require('../../assets/PNG/Group6.png') },
];
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.mainContainer}>
          <View style={styles.inputWrapper}>
            ...
            >
              <Image
                source={require('../../assets/PNG/settings_425734.png')}
      ...
      <View style={styles.bottomNav}>
        ...
        <Pressable>
          <Image
            source={require('../../assets/PNG/connect.png')}
            style={styles.navIcon}
          />
        </Pressable>
