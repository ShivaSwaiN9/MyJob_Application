...
const BottomSheet: React.FC<BottomSheetProps> = ({ visible, onClose, onOptionSelect, selectedOption }) => {
  ...
  const options = [
    { id: 'delete', title: 'Delete', icon: require('../../assets/PNG/Delete.png') },
    { id: 'turnoff', title: 'Turn off notifications', icon: require('../../assets/PNG/Bell.png') },
    { id: 'settings', title: 'Setting', icon: require('../../assets/PNG/Setting.png') },
  ];
...
const NotificationItem: React.FC<{ item: NotificationItem; onMorePress: () => void }> = ({ item, onMorePress }) => (
  <View style={styles.notificationItem}>
    ...
    <Pressable style={styles.moreButton} onPress={onMorePress}>
      <Image source={require('../../assets/PNG/more.png')} style={styles.moreIcon} />
    </Pressable>
  </View>
);
      ...
      {notifications.length > 0 ? (
        ...
        <View style={styles.noNotifications}>
          ...
          <View style={styles.imageWrapper}>
            <Image
              source={require('../../assets/PNG/NoNotifications.png')}
